...
extern void odin_model_Sandal_initmod_desolve(void *);
extern void odin_model_Sandal_output_dde(void *);
extern void odin_model_Sandal_rhs_dde(void *);
extern void odin_model_Sandal_rhs_desolve(void *);
...
extern SEXP odin_model_Sandal_contents(SEXP);
extern SEXP odin_model_Sandal_create(SEXP);
extern SEXP odin_model_Sandal_initial_conditions(SEXP, SEXP);
extern SEXP odin_model_Sandal_metadata(SEXP);
extern SEXP odin_model_Sandal_rhs_r(SEXP, SEXP, SEXP);
extern SEXP odin_model_Sandal_set_initial(SEXP, SEXP, SEXP, SEXP);
extern SEXP odin_model_Sandal_set_user(SEXP, SEXP);
...
static const R_CMethodDef CEntries[] = {
    ...
    {"odin_model_Sandal_initmod_desolve",         (DL_FUNC) &odin_model_Sandal_initmod_desolve,         1},
    {"odin_model_Sandal_output_dde",              (DL_FUNC) &odin_model_Sandal_output_dde,              1},
    {"odin_model_Sandal_rhs_dde",                 (DL_FUNC) &odin_model_Sandal_rhs_dde,                 1},
    {"odin_model_Sandal_rhs_desolve",             (DL_FUNC) &odin_model_Sandal_rhs_desolve,             1},
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"odin_model_Sandal_contents",                   (DL_FUNC) &odin_model_Sandal_contents,                   1},
    {"odin_model_Sandal_create",                     (DL_FUNC) &odin_model_Sandal_create,                     1},
    {"odin_model_Sandal_initial_conditions",         (DL_FUNC) &odin_model_Sandal_initial_conditions,         2},
    {"odin_model_Sandal_metadata",                   (DL_FUNC) &odin_model_Sandal_metadata,                   1},
    {"odin_model_Sandal_rhs_r",                      (DL_FUNC) &odin_model_Sandal_rhs_r,                      3},
    {"odin_model_Sandal_set_initial",                (DL_FUNC) &odin_model_Sandal_set_initial,                4},
    {"odin_model_Sandal_set_user",                   (DL_FUNC) &odin_model_Sandal_set_user,                   2},
