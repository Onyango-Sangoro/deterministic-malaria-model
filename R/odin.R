...
odin_model_mass_effect_pp_ <- R6::R6Class(
  "odin_model",
  cloneable = FALSE,
  ...
  private = list(
    ...
    interpolate_t = NULL,
    cfuns = list(
      rhs_dde = "odin_model_mass_effect_pp_rhs_dde",
      rhs_desolve = "odin_model_mass_effect_pp_rhs_desolve",
      initmod_desolve = "odin_model_mass_effect_pp_initmod_desolve",
      output_dde = "odin_model_mass_effect_pp_output_dde"),
    dll = "ICDMM",
    user = c("aD", "age", "age_20_factor", "age_rate", "age05", "age20l",
             "age20u", "age59", "age6", "b0", "b1", "betaL", "bites_Bed",
             "bites_Indoors", "cD", "chi", "cT", "cU", "d_IRS0", "d_ITN0",
             "d1", "dB", "dCA", "dCM", "dE", "dEL", "delayGam", "delayMos",
             "den", "dID", "dLL", "dPL", "eta", "fD0", "foi_age", "ft",
             ...
             "init_PL", "init_S", "init_Sv", "init_T", "init_U", "irs_cov",
             "IRS_interval", "irs_loss", "itn_cov", "ITN_interval",
             "ITN_IRS_on", "itn_loss", "Iv_fixed", "kB", "kC", "kD", "mu0",
             "muEL", "muLL", "muPL", "mv0", "na", "nh", "num_int", "omega",
    ...
    registration = function() {
      if (FALSE) {
        .C("odin_model_mass_effect_pp_rhs_dde", package = "ICDMM")
        .C("odin_model_mass_effect_pp_rhs_desolve", package = "ICDMM")
        .C("odin_model_mass_effect_pp_initmod_desolve", package = "ICDMM")
        .C("odin_model_mass_effect_pp_output_dde", package = "ICDMM")
      }
    },

    ## This only does something in delay models
    set_initial = function(t, y, use_dde) {
      .Call("odin_model_mass_effect_pp_set_initial", private$ptr, t, y, use_dde,
            PACKAGE= "ICDMM")
    },

    update_metadata = function() {
      meta <- .Call("odin_model_mass_effect_pp_metadata", private$ptr,
                    PACKAGE = "ICDMM")
      private$variable_order <- meta$variable_order
      private$output_order <- meta$output_order
      private$n_out <- meta$n_out
  ...
  public = list(
    initialize = function(..., user = list(...), use_dde = FALSE,
                          unused_user_action = NULL) {
      private$odin <- asNamespace("odin")
      private$ptr <- .Call("odin_model_mass_effect_pp_create", user, PACKAGE = "ICDMM")
      self$set_user(user = user, unused_user_action = unused_user_action)
      private$use_dde <- use_dde
      private$update_metadata()
    },
    ...
    ir = function() {
      path_ir <- system.file("odin/odin_model_mass_effect_pp.json", mustWork = TRUE,
                             package = "ICDMM")
      json <- readLines(path_ir)
      class(json) <- "json"
      json
    ...
    set_user = function(..., user = list(...), unused_user_action = NULL) {
      private$odin$support_check_user(user, private$user, unused_user_action)
      .Call("odin_model_mass_effect_pp_set_user", private$ptr, user, PACKAGE = "ICDMM")
      private$update_metadata()
    },
    ...
    ## time in.
    initial = function(t) {
      .Call("odin_model_mass_effect_pp_initial_conditions", private$ptr, t, PACKAGE = "ICDMM")
    },

    rhs = function(t, y) {
      .Call("odin_model_mass_effect_pp_rhs_r", private$ptr, t, y, PACKAGE = "ICDMM")
    },
    ...
    contents = function() {
      .Call("odin_model_mass_effect_pp_contents", private$ptr, PACKAGE = "ICDMM")
    },
...
odin_model_mass_effect_pp <- function(..., user = list(...), use_dde = FALSE,
                     unused_user_action = NULL) {
  asNamespace("odin")$deprecated_constructor_call("odin_model_mass_effect_pp")
  odin_model_mass_effect_pp_$new(user = user, use_dde = use_dde,
                unused_user_action = unused_user_action)
}
class(odin_model_mass_effect_pp) <- "odin_generator"
attr(odin_model_mass_effect_pp, "generator") <- odin_model_mass_effect_pp_
odin_model_mass_effect_ <- R6::R6Class(
  "odin_model",
  cloneable = FALSE,
  ...
  private = list(
    ...
    interpolate_t = NULL,
    cfuns = list(
      rhs_dde = "odin_model_mass_effect_rhs_dde",
      rhs_desolve = "odin_model_mass_effect_rhs_desolve",
      initmod_desolve = "odin_model_mass_effect_initmod_desolve",
      output_dde = "odin_model_mass_effect_output_dde"),
    dll = "ICDMM",
    user = c("aD", "age", "age_20_factor", "age_rate", "age05", "age20l",
             "age20u", "age59", "age6", "b0", "b1", "betaL", "bites_Bed",
             "bites_Indoors", "cD", "chi", "cT", "cU", "d_IRS0", "d_ITN0",
    ...
    registration = function() {
      if (FALSE) {
        .C("odin_model_mass_effect_rhs_dde", package = "ICDMM")
        .C("odin_model_mass_effect_rhs_desolve", package = "ICDMM")
        .C("odin_model_mass_effect_initmod_desolve", package = "ICDMM")
        .C("odin_model_mass_effect_output_dde", package = "ICDMM")
      }
    },

    ## This only does something in delay models
    set_initial = function(t, y, use_dde) {
      .Call("odin_model_mass_effect_set_initial", private$ptr, t, y, use_dde,
            PACKAGE= "ICDMM")
    },

    update_metadata = function() {
      meta <- .Call("odin_model_mass_effect_metadata", private$ptr,
                    PACKAGE = "ICDMM")
      private$variable_order <- meta$variable_order
      private$output_order <- meta$output_order
      private$n_out <- meta$n_out
  ...
  public = list(
    initialize = function(..., user = list(...), use_dde = FALSE,
                          unused_user_action = NULL) {
      private$odin <- asNamespace("odin")
      private$ptr <- .Call("odin_model_mass_effect_create", user, PACKAGE = "ICDMM")
      self$set_user(user = user, unused_user_action = unused_user_action)
      private$use_dde <- use_dde
      private$update_metadata()
    },
    ...
    ir = function() {
      path_ir <- system.file("odin/odin_model_mass_effect.json", mustWork = TRUE,
                             package = "ICDMM")
      json <- readLines(path_ir)
      class(json) <- "json"
      json
    ...
    set_user = function(..., user = list(...), unused_user_action = NULL) {
      private$odin$support_check_user(user, private$user, unused_user_action)
      .Call("odin_model_mass_effect_set_user", private$ptr, user, PACKAGE = "ICDMM")
      private$update_metadata()
    },
    ...
    ## time in.
    initial = function(t) {
      .Call("odin_model_mass_effect_initial_conditions", private$ptr, t, PACKAGE = "ICDMM")
    },

    rhs = function(t, y) {
      .Call("odin_model_mass_effect_rhs_r", private$ptr, t, y, PACKAGE = "ICDMM")
    },
    ...
    contents = function() {
      .Call("odin_model_mass_effect_contents", private$ptr, PACKAGE = "ICDMM")
    },
...
odin_model_mass_effect <- function(..., user = list(...), use_dde = FALSE,
                     unused_user_action = NULL) {
  asNamespace("odin")$deprecated_constructor_call("odin_model_mass_effect")
  odin_model_mass_effect_$new(user = user, use_dde = use_dde,
                unused_user_action = unused_user_action)
}
class(odin_model_mass_effect) <- "odin_generator"
attr(odin_model_mass_effect, "generator") <- odin_model_mass_effect_
odin_model_Sandal_ <- R6::R6Class(
  "odin_model",
  cloneable = FALSE,
  ...
  private = list(
    ...
    interpolate_t = NULL,
    cfuns = list(
      rhs_dde = "odin_model_Sandal_rhs_dde",
      rhs_desolve = "odin_model_Sandal_rhs_desolve",
      initmod_desolve = "odin_model_Sandal_initmod_desolve",
      output_dde = "odin_model_Sandal_output_dde"),
    dll = "ICDMM",
    user = c("aD", "age", "age_20_factor", "age_rate", "age05", "age20l",
             "age20u", "age59", "b0", "b1", "betaL", "bites_Bed",
             "bites_Indoors", "cD", "chi", "cT", "cU", "d_IRS0", "d_ITN0",
    ...
    registration = function() {
      if (FALSE) {
        .C("odin_model_Sandal_rhs_dde", package = "ICDMM")
        .C("odin_model_Sandal_rhs_desolve", package = "ICDMM")
        .C("odin_model_Sandal_initmod_desolve", package = "ICDMM")
        .C("odin_model_Sandal_output_dde", package = "ICDMM")
      }
    },

    ## This only does something in delay models
    set_initial = function(t, y, use_dde) {
      .Call("odin_model_Sandal_set_initial", private$ptr, t, y, use_dde,
            PACKAGE= "ICDMM")
    },

    update_metadata = function() {
      meta <- .Call("odin_model_Sandal_metadata", private$ptr,
                    PACKAGE = "ICDMM")
      private$variable_order <- meta$variable_order
      private$output_order <- meta$output_order
      private$n_out <- meta$n_out
  ...
  public = list(
    initialize = function(..., user = list(...), use_dde = FALSE,
                          unused_user_action = NULL) {
      private$odin <- asNamespace("odin")
      private$ptr <- .Call("odin_model_Sandal_create", user, PACKAGE = "ICDMM")
      self$set_user(user = user, unused_user_action = unused_user_action)
      private$use_dde <- use_dde
      private$update_metadata()
    },
    ...
    ir = function() {
      path_ir <- system.file("odin/odin_model_Sandal.json", mustWork = TRUE,
                             package = "ICDMM")
      json <- readLines(path_ir)
      class(json) <- "json"
      json
    ...
    set_user = function(..., user = list(...), unused_user_action = NULL) {
      private$odin$support_check_user(user, private$user, unused_user_action)
      .Call("odin_model_Sandal_set_user", private$ptr, user, PACKAGE = "ICDMM")
      private$update_metadata()
    },
    ...
    ## time in.
    initial = function(t) {
      .Call("odin_model_Sandal_initial_conditions", private$ptr, t, PACKAGE = "ICDMM")
    },

    rhs = function(t, y) {
      .Call("odin_model_Sandal_rhs_r", private$ptr, t, y, PACKAGE = "ICDMM")
    },
    ...
    contents = function() {
      .Call("odin_model_Sandal_contents", private$ptr, PACKAGE = "ICDMM")
    },
...
odin_model_Sandal <- function(..., user = list(...), use_dde = FALSE,
                     unused_user_action = NULL) {
  asNamespace("odin")$deprecated_constructor_call("odin_model_Sandal")
  odin_model_Sandal_$new(user = user, use_dde = use_dde,
                unused_user_action = unused_user_action)
}
class(odin_model_Sandal) <- "odin_generator"
attr(odin_model_Sandal, "generator") <- odin_model_Sandal_
